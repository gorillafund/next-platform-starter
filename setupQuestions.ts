...
export const setupQuestions: Question[] = [
  ...
  },
  {
    ...
    type: 'radio',
    options: [
      'Only our in-house team',
      'Only external portfolio managers',
      'Both in-house and external managers'
    ],
    required: true,
    category: 'Products & Strategies'
  },
  ...
  },
  {
    ...
    type: 'textarea',
    placeholder: 'e.g., "CEX trading on Kraken/Coinbase, DEX execution on Uniswap with max 0.5% slippage, no MEV-exposed venues"',
    required: false,
    category: 'Crypto Custody & Trading'
  },
  ...
  // Third-Party Services
  {
    ...
    type: 'multi-select',
    options: [
      'CryptoMatter Analytics',
      'Fountainhead Digital Analytics',
      'None - use built-in analytics only'
    ],
    required: true,
  ...
  },
  {
    ...
    options: [
      ...
      'None - use internal risk assessment'
    ],
    required: true,
    category: 'Third-Party Services'
  },
  ...
  },
  {
    ...
    type: 'textarea',
    placeholder: 'e.g., "Bloomberg Terminal integration, custom ESG scoring provider, specific market data feeds..."',
    required: false,
    category: 'Third-Party Services'
  }
];
